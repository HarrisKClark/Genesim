...
React and TypeScript frontend for the Genesim genetic circuit simulation platform. Provides a visual interface for designing genetic circuits and viewing simulation results.
...
- **Dual View Modes**: 
  ...
  - DNA view: Base-pair level sequence visualization
- **Interactive Canvas**: 
