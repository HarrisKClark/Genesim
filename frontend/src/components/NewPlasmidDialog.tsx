...
interface NewPlasmidDialogProps {
  isOpen: boolean
  defaultBackbone: BackboneSpec
  onCreate: (backbone: BackboneSpec) => void
  onClose: () => void
}

export default function NewPlasmidDialog({ isOpen, defaultBackbone, onCreate, onClose }: NewPlasmidDialogProps) {
      ...
      <div style={{ ...styles.container, minWidth: 680, maxWidth: '95vw' }}>
        ...
        <div style={{ ...styles.body, display: 'flex', gap: 16, flexWrap: 'wrap' }}>
          ...
          <div style={{ flex: '1 1 280px', minWidth: 260 }}>
            <label style={styles.label}>Backbone Library</label>
            <select
              value={selectedId}
        ...
        <div style={{ ...styles.footer, justifyContent: 'space-between' }}>
          <div style={{ display: 'flex', gap: 8 }}>
            ...
            <button
              onClick={async () => {
                if (selectedId === 'default' || selectedId === 'custom') return
              ...
              disabled={busy || selectedId === 'default' || selectedId === 'custom' || !!items.find((x) => x.id === selectedId)?.builtIn}
              style={styles.secondaryButton}
